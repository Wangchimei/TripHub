...
*/
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        exports.computeDurationGreatestUnit =
          util_1.computeDurationGreatestUnit;
        ...
        exports.populateInstanceComputableOptions =
          locale_1.populateInstanceComputableOptions;
        ...
        exports.eventFootprintToComponentFootprint =
          util_2.eventFootprintToComponentFootprint;
        exports.eventInstanceToEventRange = util_2.eventInstanceToEventRange;
        exports.eventInstanceToUnzonedRange =
          util_2.eventInstanceToUnzonedRange;
    ...
    ------------------------------------------------------------------------------------------------------------------*/
          ...
          View.prototype.reportEventResize = function(
            ...
            var resizeDelta =
              ...
              eventMutation.dateMutation.startDelta;
...
*/
    ...
    ------------------------------------------------------------------------------------------------------------------*/
          ...
          DateProfileGenerator.prototype.build = function(
            ...
            isValid = currentInfo.unzonedRange.intersectsWith(
              validUnzonedRange
            );
            return {
            ...
            var dragListener = (this.dragListener = new HitDragListener_1.default(
              view,
              {
                ...
                hitOver: function(hit, isOrig, origHit) {
                  ...
                  origFootprint = origHit.component.getSafeHitFootprint(
                    origHit
                  );
